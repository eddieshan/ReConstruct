    ...
    type private Voxel =
        ...
        member private x.Polygonize(row, column) =
            ...
            if EdgeTable.[cubeIndex] <> 0 then
                ...
                let vertlist = Array.zeroCreate<Point3D> 12
                ...
                while TriTable.[cubeIndex, index] <> -1 do                    
                    vertlist.[TriTable.[cubeIndex, index]] |> x.AddPoint
                    vertlist.[TriTable.[cubeIndex, index + 1]] |> x.AddPoint
                    vertlist.[TriTable.[cubeIndex, index + 2]] |> x.AddPoint
                    index <- index + 3
        ...
        let voxel = 
            {
                ...
                Back = back
                IsoLevel = isoLevel
                Vertices = Array.zeroCreate<Point3D> 8
